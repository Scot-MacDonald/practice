              ...
              {items?.map((item, index) => (
                ...
                >
                  <Accordion.Header>
                    <Accordion.Trigger
                      className={cn(
                        "w-full text-left px-4 py-6 flex justify-between items-center cursor-pointer",
                  ...
                  <Accordion.Content className="px-4 pb-6">
                    ...
                    {item.enableLink && item.link && (
                      <div className="mt-4">
                        <CMSLink
                          {...item.link}
                          className="inline-block text-sm px-4 py-2 rounded text-[#7eb36a] bg-[rgba(126,179,106,0.3)] hover:bg-[#7eb36a] hover:text-white transition-colors duration-200"
                        />
                      </div>
                    )}
                  </Accordion.Content>
